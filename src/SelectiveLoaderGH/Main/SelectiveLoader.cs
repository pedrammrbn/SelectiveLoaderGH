...
namespace SelectiveLoaderGH.Main
{
    public class SelectiveLoader : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public SelectiveLoader()
          : base("Select Plugins", "Select",
            "Opens a new dialogue to select which plugins you want to load.",
            "SelectiveLoader", "Main")
        {
        }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("046dda44-bd10-43e6-8666-5adfcb3acc98");
    }
}